...
public:
    ...
    enum Type
    {
        ...
        Gravity,          ///< Measures the dr and intensity of gravity, independent of device acceleration (m/s^2)
        UserAcceleration, ///< Measures the dr and intensity of device acceleration, independent of the gravity (m/s^2)
